...
public class PlayerShoot : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        //se atira instancia o prefab
        if (Input.GetButtonDown("Fire1"))
        {
            GameObject myProjectile = Instantiate(projectilesPrefab[indexWeapon], transform.position + transform.forward, transform.rotation);//Quaternion.identity
